...
defmodule Batteries.Jason.EncodeError do
...
defmodule Batteries.Jason.Encode do
  @moduledoc """
  ...
  alias Batteries.Jason.{Codegen, EncodeError, Encoder, Fragment}
  ...
  def encode(value, opts) do
    ...
    try do
      ...
      :throw, %EncodeError{} = e ->
        {:error, e}
      :error, %Protocol.UndefinedError{protocol: Batteries.Jason.Encoder} = e ->
        {:error, e}
    end
  end
  ...
  @doc """
  Equivalent to calling the `Batteries.Jason.Encoder.encode/2` protocol function.
