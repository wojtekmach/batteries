...
defmodule Batteries.Jason do
  @moduledoc """
  A blazing fast JSON parser and generator in pure Elixir.
  """

  alias Batteries.Jason.{Encode, Decoder, DecodeError, EncodeError, Formatter}
  ...
  ## Examples
      ...
      iex> Batteries.Jason.decode("{}")
      {:ok, %{}}

      iex> Batteries.Jason.decode("invalid")
      {:error, %Batteries.Jason.DecodeError{data: "invalid", position: 0, token: nil}}
  """
  ...
  ## Examples
      ...
      iex> Batteries.Jason.decode!("invalid")
      ** (Batteries.Jason.DecodeError) unexpected byte at position 0: 0x69 ('i')
  ...
  The generation is controlled by the `Batteries.Jason.Encoder` protocol,
  ...
  ## Options
    ...
    * `:pretty` - controls pretty printing of the output. Possible values are:
      ...
      * a keyword of options as specified by `Batteries.Jason.Formatter.pretty_print/2`.

  ## Examples

      iex> Batteries.Jason.encode(%{a: 1})
      {:ok, ~S|{"a":1}|}

      iex> Batteries.Jason.encode("\\xFF")
      {:error, %Batteries.Jason.EncodeError{message: "invalid byte 0xFF in <<255>>"}}
  ...
  ## Examples
      ...
      iex> Batteries.Jason.encode!("\\xFF")
      ** (Batteries.Jason.EncodeError) invalid byte 0xFF in <<255>>
  ...
  ## Examples
      ...
      iex> {:ok, iodata} = Batteries.Jason.encode_to_iodata(%{a: 1})
      iex> IO.iodata_to_binary(iodata)
      ~S|{"a":1}|

      iex> Batteries.Jason.encode_to_iodata("\\xFF")
      {:error, %Batteries.Jason.EncodeError{message: "invalid byte 0xFF in <<255>>"}}
  ...
  ## Examples
      ...
      iex> iodata = Batteries.Jason.encode_to_iodata!(%{a: 1})
      iex> IO.iodata_to_binary(iodata)
      ~S|{"a":1}|
